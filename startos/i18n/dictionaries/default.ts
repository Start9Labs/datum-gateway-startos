...
const dict = {
  ...
  'RPC URL': 202,
  'RPC URL for communication with local bitcoind. (GBT Template Source)': 203,
  ...
  'Listen Port': 208,
  'Listening port for Stratum Gateway.': 209,
  'Maximum Clients Per Thread': 210,
  'Maximum clients per Stratum server thread.': 211,
  'Max Threads': 212,
  'Maximum Stratum server threads (integer, default: 8)': 213,
  'Max Clients': 214,
  'Maximum total Stratum clients before rejecting connections (integer, default: 2048)': 215,
  'Trust PROXY': 216,
  'Number of PROXY line trusted': 217,
  'Minimum Difficulty': 218,
  'Work difficulty floor (integer, default: 16384)': 219,
  'Target Shares per Minute': 220,
  'Adjust work difficulty to target this many shares per minute (integer, default: 8)': 221,
  'Difficulty Update Speed': 222,
  'How many shares before considering a quick diff update (integer, default: 8)': 223,
  'Difficulty Delta': 224,
  'How many times faster than our target does the miner have to be before we enforce a quick diff bump (integer, default: 8)': 225,
  'Seconds Until Shares Considered Stale': 226,
  'How many seconds after a job is generated before a share submission is considered stale? (integer, default: 120)': 227,
  'Fingerprint Miners': 228,
  'Attempt to fingerprint miners for better use of coinbase space (boolean, default: true)': 229,
  ...
  'A unique ID between 1 and 65535. This is appended to the coinbase. Make unique per instance of datum with the same coinbase tags.': 247,
  'API': 248,
  'Settings for the Datum Gateway Dashboard': 249,
  'Listening port for Datum Gateway Dashboard.': 250,
  ...
  'Minimum log level for console messages (0=All, 1=Debug, 2=Info, 3=Warn, 4=Error, 5=Fatal) (integer, default: 2)': 257,
  'Log to File': 258,
  ...
  'Pool Host': 266,
  'Remote DATUM server host/ip to use for decentralized pooled mining (string, default: datum.mine.ocean.xyz)': 267,
  'Pool Port': 268,
  'Remote DATUM server port (integer, default: 28915)': 269,
  'Pool Pubkey': 270,
  'Public key of the DATUM server for initiating encrypted connection. Get from secure location, or set to empty to auto-fetch.': 271,
  'Pool Pass Workers': 272,
  'Pass stratum miner usernames as sub-worker names to the pool (boolean, default: true)': 273,
  ...
  'Always Pay Self': 276,
  'Always include my datum.pool_username payout in my blocks if possible (boolean, default: true)': 277,
